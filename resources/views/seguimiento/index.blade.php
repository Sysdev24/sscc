...
<div class="container">
    <div class="breadcrumbs">
        <FONT COLOR="white">
        <h2 class="mb-3 ml-3 font-weight-bold"><a href="{{route('seguimiento.index')}}">
                <span class="icofont-home"></span>
            </a> / SEGUIMIENTO CORRESPONDENCIA</h2></FONT>
    </div>
...
<div class="modal fade" id="winEditEstatus" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title " id="exampleModalLongTitle">SUSPENDER LA CORRESPONDENCIA</h5>
...
<div class="modal fade" id="winEdit" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg with-xl">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title " id="exampleModalLongTitle">SEGUIMIENTO REGISTRO</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true" class="icofont-close-squared-alt"></span>
                </button>
            </div>
...
<div class="modal fade" id="winEdit" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg with-xl">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title " id="exampleModalLongTitle">VERIFICAR FIRMANTE</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true" class="icofont-close-squared-alt"></span>
                </button>
            </div>
...
{{-- ZONA PARA ANEXAR DOCUMENTO  --}}
<div class="modal fade" id="winSubir" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title " id="exampleModalLongTitle">ANEXAR DOCUMENTO</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true" class="icofont-close-squared-alt"></span>
                </button>
            </div>
 ...
 */
$(document).on("click", ".winAnexar", function (e) {
    e.preventDefault();
    $("#winSubir .modal-body").html(
    ...
    $.get(url_record, function (res) {
        $("#winSubir .modal-body").html(res);
        $("#winSubir .modal-body").find("form input:visible:first").focus();
    });
});    
