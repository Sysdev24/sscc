<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="8%">ENTE</th>
    </thead>
</table>
...
@section('js')
    <script>
        ...
        let table = $('#data-table').DataTable({
            ...
            ajax: URL_BASE + '/api/ente',
            columns: [
                {
                    data: "id_ente",render: function(data, type, row) {
                        return `<a href="#winEdit" data-registro='${URL_BASE}/ente/${data}/edit'"
...

                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a href="#winEditEstatus" data-registro="${URL_BASE}/ente/${row.id_ente}"
