<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="8%">CARGO </th>
...
<script>
    ...
    let table= $('#data-table').DataTable({
        ...
        ajax: URL_BASE+'/api/cargo',
        columns:[
            {data:"id_cargo",render:function(data, type, row){
                return `<a href="#winEdit" data-registro='${URL_BASE}/cargo/${data}/edit'"
            ...
            {data:"id_status",render:function(data, type, row){
                ...
                <a href="#winEditEstatus" data-registro="${URL_BASE}/cargo/${row.id_cargo}"
