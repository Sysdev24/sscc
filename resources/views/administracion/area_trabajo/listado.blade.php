<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="8%">TIPO CORRESPONDENCIA</th>
    </thead>
</table>
...
@section('js')
    <script>
        ...
        let table = $('#data-table').DataTable({
            ...
            ajax: URL_BASE + '/api/area_trabajo',
            columns: [
                {
                    data: "id_area_trabajo",render: function(data, type, row) {
                        return `<a href="#winEdit" data-registro='${URL_BASE}/area_trabajo/${data}/edit'"
...

                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a href="#winEditEstatus" data-registro="${URL_BASE}/area_trabajo/${row.id_area_trabajo}"
