<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="8%">ESTATUS </th>
		<th style="text-align: center" width="8%">SIGLAS </th>
    </thead>
</table>
    ...
    let table= $('#data-table').DataTable({
        ...
        columns:[
            {data:"id_estatus",render:function(data, type, row){
                ...
                <a href="#winEditEstatus" data-registro="${URL_BASE}/estatus/${row.id_estatus}"
