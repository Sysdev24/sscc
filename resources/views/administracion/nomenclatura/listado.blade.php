<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="8%">NOMENCLATURA</th>
    </thead>
</table>
...
@section('js')
    <script>
        ...
        let table = $('#data-table').DataTable({
            ...
            ajax: URL_BASE + '/api/nomenclatura',
            columns: [
                {
                    data: "id_nomenclatura",render: function(data, type, row) {
                        return `<a href="#winEdit" data-registro='${URL_BASE}/nomenclatura/${data}/edit'"
...

                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a href="#winEditEstatus" data-registro="${URL_BASE}/nomenclatura/${row.id_nomenclatura}"
