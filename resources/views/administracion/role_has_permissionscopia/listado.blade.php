<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="75%">ROLES</th>
        <th style="text-align: center" width="75%">PERMISOS</th>
    </thead>
</table>
...
@section('js')
    <script>
        ...
        let table = $('#data-table').DataTable({
            ...
            ajax: URL_BASE + '/api/role_has_permissions',
            columns: [
                {
                    data: "id_roles_has_permissions",render: function(data, type, row) {
                        return `<a href="#winEdit" data-registro='${URL_BASE}/role_has_permissions/${data}/edit'"
...

                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a href="#winEditEstatus" data-registro="${URL_BASE}/role_has_permissions/${row.id_roles_has_permissions}"
