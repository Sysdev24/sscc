<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="8%">GERENCIA </th>
...
<script>
    ...
    let table= $('#data-table').DataTable({
        ...
        ajax: URL_BASE+'/api/gerencia',
        columns:[
            {data:"id_gerencia",render:function(data, type, row){
                return `<a href="#winEdit" data-registro='${URL_BASE}/gerencia/${data}/edit'"
            ...
            {data:"id_status",render:function(data, type, row){
                ...
                <a href="#winEditEstatus" data-registro="${URL_BASE}/gerencia/${row.id_gerencia}"
