<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="8%">CORRESPONDENCIA</th>
    </thead>
</table>
...
@section('js')
    <script>
        ...
        let table = $('#data-table').DataTable({
            ...
            ajax: URL_BASE + '/api/tipo_correspondencia',
            columns: [
                {
                    data: "id_tipo_correspondencia",render: function(data, type, row) {
                        return `<a href="#winEdit" data-registro='${URL_BASE}/tipo_correspondencia/${data}/edit'"
...

                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a href="#winEditEstatus" data-registro="${URL_BASE}/tipo_correspondencia/${row.id_tipo_correspondencia}"
